---
title: Contact
description: Get in touch with Joshua Oh (Oh Yu Qiao) — email, GitHub and resume.
---
...
-   :fontawesome-solid-envelope:{ .lg } &nbsp; **Email**
    ...
    [yuqiao.oh@gmail.com](mailto:yuqiao.oh@gmail.com)

    Best for internship enquiries, project questions or a copy of my resume.

-   :fontawesome-brands-github:{ .lg } &nbsp; **GitHub**

    ---

    [github.com/JoshuaOhYQ](https://github.com/JoshuaOhYQ)

    Source for this site and my project work.
